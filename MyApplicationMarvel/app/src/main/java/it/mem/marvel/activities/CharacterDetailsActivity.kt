package it.mem.marvel.activities
...
import it.mem.marvel.data.local.FavoriteCharacters
import it.mem.marvel.data.local.FavoriteCharactersDao
import it.mem.marvel.data.local.FavoriteCharactersDatabase
import it.mem.marvel.databinding.ActivityCharacterDetailsBinding
import it.mem.marvel.data.model.api.MarvelAPI
import it.mem.marvel.data.model.paging.characters.characterdetails.*
...
class CharacterDetailsActivity : AppCompatActivity() {
    ...
    private var recyclerStateEvents: Parcelable? = null
        ...
        if (id != null) {
            CoroutineScope(Dispatchers.IO).launch {
                ...
                launch(Dispatchers.Main) {
                    ...
                    binding.recyclerEvents.adapter = adapterStories
            ...
            binding.txtEvents.text=getString(R.string.events_string)
        ...
        viewModelStories.getStoriesList(id)
            ...
            .subscribe(
                { list ->
                    ...
                    if (recyclerStateEvents != null) {
                        binding.recyclerEvents.layoutManager?.onRestoreInstanceState(recyclerStateEvents)
                        recyclerStateEvents = null
                    }
                },
                { e ->
                    Log.e("Marvel", "Error", e)
