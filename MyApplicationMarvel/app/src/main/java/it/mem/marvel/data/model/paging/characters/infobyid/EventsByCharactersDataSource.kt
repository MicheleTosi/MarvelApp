...
class EventsByCharactersDataSource (private val marvelAPI: MarvelAPI, private val compositeDisposable: CompositeDisposable, private val id:Int):
    ...
    private fun createObservable(requestedPage:Int,
        ...
        compositeDisposable.add(
            marvelAPI.characterEvents(id,requestedPage*requestedLoadSize)
                .subscribe(
                    {response->
