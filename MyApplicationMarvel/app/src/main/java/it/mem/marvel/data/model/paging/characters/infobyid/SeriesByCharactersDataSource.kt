...
class SeriesByCharactersDataSource (private val marvelAPI: MarvelAPI, private val compositeDisposable: CompositeDisposable, private val id:Int):
    ...
    private fun createObservable(requestedPage:Int,
        ...
        compositeDisposable.add(
            marvelAPI.characterSeries(id,requestedPage*requestedLoadSize)
                .subscribe(
                       {response->
